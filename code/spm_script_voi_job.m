...
matlabbatch{1}.spm.util.voi.adjust = 9;
matlabbatch{1}.spm.util.voi.session = 1;
matlabbatch{1}.spm.util.voi.name = 'R_LOC'; 
matlabbatch{1}.spm.util.voi.roi{1}.sphere.centre = RLOCcoords(i,:); 
...
matlabbatch{2}.spm.util.voi.name = 'R_DLPFC'; 
matlabbatch{2}.spm.util.voi.roi{1}.sphere.centre = RDLPFCcoords(i,:); 
...
matlabbatch{3}.spm.util.voi.spmmat = strcat(subjDir,'/SPM.mat');
matlabbatch{3}.spm.util.voi.adjust = 9;
matlabbatch{3}.spm.util.voi.session = 1;
matlabbatch{3}.spm.util.voi.name = 'R_AI'; 
matlabbatch{3}.spm.util.voi.roi{1}.sphere.centre = RAIcoords(i,:); 
matlabbatch{3}.spm.util.voi.roi{1}.sphere.radius = 5;
matlabbatch{3}.spm.util.voi.roi{1}.sphere.move.fixed = 1;
matlabbatch{3}.spm.util.voi.expression = 'i1';

matlabbatch{4}.spm.util.voi.spmmat = strcat(subjDir,'/SPM.mat');
matlabbatch{4}.spm.util.voi.adjust = 9;
matlabbatch{4}.spm.util.voi.session = 1;
