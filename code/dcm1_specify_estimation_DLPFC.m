...
model_names = {
     %'fullModel'
     'reducedModel'
%     'InhonAGandAIonly' %bilinear
%     'InhonLOCtoAGandLOCtoAI' %bilinear
%     'Inhonall' %bilinear
%     'NonLinAGonLOCtoAIandInh-nodes' %nonlinear
%     'NonLinAGonLOCtoAIandInh-bi' %nonlinear
%     'NonLinAGonLOCtoAIandall-bi' %nonlinear
%     'NonLinAGonLOCtoAIandAGtoAIconandInh-bi' %nonlinear
%     'NonLinAGonAItoPIandInh-nodes' %nonlinear
%     'NonLinAGonAItoPIandInh-bi' %nonlinear
%     'NonLinAGonAItoPIandall-bi' %nonlinear
%     'NonLinAGonAItoPInoLOCtoAIandInh-bi'
%     'NonLinAGonAItoPInoAGtoAIandInh-bi'
%     'NonLinAGonAItoPInoLOCtoAInoAGtoAIandInh-bi'
%    'FacesonLOConly_DLPFC' %bilinear
%    'InhonDLPFCandAIonly' %bilinear
%    'Bilinear-all' %bilinear
%     'Inhonall_DLPFC' %bilinear
%     'NonLinDLPFConLOCtoAIandInh-nodes' %nonlinear
%     'NonLinDLPFConLOCtoAIandInh-bi' %nonlinear
%     'NonLinDLPFConLOCtoAIandall-bi' %nonlinear
%     'NonLinDLPFConLOCtoAIandAGtoAIconandInh-bi' %nonlinear
%     'NonLinDLPFConAItoPIandInh-nodes' %nonlinear
%     'NonLinDLPFConAItoPIandInh-bi' %nonlinear
%     'NonLinDLPFConAItoPIandall-bi' %nonlinear
%    'NonLinDLPFConAItoPIandInh-binoLOCtoAImodel12'
%    'NonLinDLPFConAItoPIandInh-binoLOCtoAImodel12nofeedback' %nonlinear
%     'NonLinDLPFConAItoPInoDLPFCtoAIandInh-bi'
%     'NonLinDLPFConAItoPInoLOCtoAInoDLPFCtoAIandInh-bi'
    };
